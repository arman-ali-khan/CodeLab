...
const Footer = () => {
    ...
    return (
        <footer className={`${dark? 'bg-base-100':'bg-[#1e2b47] text-white border-t-2 '}`}>
        <div className="container pt-4 px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
            <div className="grid grid-cols-12">
                <div className="pb-6 col-span-full md:pb-0 md:col-span-6">
                    <Link rel="noopener noreferrer" to="/" className="flex justify-center space-x-3 md:justify-start">
                       ...
                       <img src="http://img.arman.top/images/EJEXN.png" alt="" />
                        </div>
                        <span className="self-center text-2xl font-semibold"><img src='http://img.arman.top/images/UYwKj.png' alt='logo'/></span>
                    </Link>
                </div>
