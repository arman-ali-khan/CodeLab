...
const Register = () => {
  ...
  <form novalidate="" action="" className="space-y-6 ng-untouched ng-pristine ng-valid">
      <div className="space-y-1 text-sm">
          <label for="name" className="block dark:text-gray-400">Full Name</label>
      ...
      <div className="space-y-1 text-sm">
          <label for="url" className="block dark:text-gray-400">Photo Url</label>
  ...
  <p className="text-xs text-center sm:px-6 dark:text-gray-400">Already have an account? 
      <Link rel="noopener noreferrer" to="/register" className="underline dark:text-gray-100"> Login</Link>
  </p>
</div>
      </div>
    );
